...
public class ThymeleafController {
	...
	@PostMapping("/")
	public String addItem(@RequestParam String newitem, @RequestParam Integer priority, Model model){

		System.out.println("New item: "+newitem + ", Priority: " + priority);

        WebClient
            .create(todolistEndpoint+newitem+"/"+priority)
            .post()
            .retrieve()
            .bodyToMono(Todo.class)
            .block();
